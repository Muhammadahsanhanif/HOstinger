...
const DashboardPage = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-full min-h-screen bg-gray-100 p-6 md:p-10 gap-10 overflow-hidden">
      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-6xl bg-white p-6 md:p-10 rounded-lg shadow-lg">
        <Image 
          src="/w=1760,sharpen=1 (6).avif" 
          alt="Web Hosting Illustration" 
          width={1200} 
          height={750} 
          className="shadow-lg w-full max-w-full md:w-1/2 h-auto object-cover rounded-lg"
        />
